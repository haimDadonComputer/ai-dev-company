...
- `users`: פרטי התחברות, גיבוב סיסמה, סטטוס וחובת החלפת סיסמה.
...
- אם נדרש `admin/123123`, לחייב החלפת סיסמה לפני כל פעולה אחרת.
...
3. אישור שהסיסמה הראשונית תחייב החלפה בהתחברות הראשונה.
